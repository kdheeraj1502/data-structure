...
public class searchstringin2dmatrix {
   public static void main(String[] args) {
      char[][] arr = new char[][]{{'G', 'E', 'E', 'K', 'S', 'F', 'O', 'R', 'G', 'E', 'E', 'K', 'S'}, {'G', 'E', 'E', 'K', 'S', 'Q', 'U', 'I', 'Z', 'G', 'E', 'E', 'K'}, {'I', 'D', 'E', 'Q', 'A', 'P', 'R', 'A', 'C', 'T', 'I', 'C', 'E'}};
      move(arr, "GEEKS");
   }
         ...
         if (arr[i][j] == s.charAt(ind)) {
            for(int dir = 0; dir < 8; ++dir) {
               ...
               for(k = 1; k < s.length(); ++k) {
                  ...
                  if (row < 0 || row >= arr.length || col < 0 || col >= arr[0].length || arr[row][col] != s.charAt(k)) {
                     break;
                  }
               }
