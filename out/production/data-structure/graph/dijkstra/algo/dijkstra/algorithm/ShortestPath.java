...
public class ShortestPath {
   public void computePaths(Vertex sourceVertex) {
      ...
      while(!priorityQueue.isEmpty()) {
         Vertex actualVertex = (Vertex)priorityQueue.poll();
         Iterator var4 = actualVertex.getAdjacenciesList().iterator();
   ...
   public static void main(String[] args) {
      ...
      vertex0.addNeighbour(new Edge(1.0, vertex0, vertex1));
      vertex0.addNeighbour(new Edge(1.0, vertex0, vertex2));
