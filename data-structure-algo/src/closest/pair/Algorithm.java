...
public class Algorithm {
	...
	private void sortByX(List<Point> points) {
		Collections.sort(points, (point, otherPoint) -> Double.compare(point.getX(), otherPoint.getX()));
	}
	...
	public static void main(String[] args) {
		...
		List<Point> points = Arrays.asList(new Point(1, 1.1), new Point(1, 2), new Point(2, 1), new Point(2, 2),
